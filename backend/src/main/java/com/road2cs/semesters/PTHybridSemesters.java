...
public class PTHybridSemesters {
    ...
    public static void register(Map<String, Semester> semesters, CourseService courseService) {
        ...
        semesters.put("ptHybridrSem1", createSemester(courseService, 1, "Fall",
                "COMP110-L", "MATH150A"));

        //Semester 2 - Spring (8 units)
        semesters.put("ptHyrbidSem2", createSemester(courseService, 2, "Spring",
                "COMP182-L", "COMP122-L"));

        //Semester 3 - Summer (3 units)
        semesters.put("ptHybridSemS1", createSemester(courseService, 3, "Summer",
                "ENG115"));
        ...
        semesters.put("ptHybridrSemS2", createSemester(courseService, 6, "Summer",
                "BIOL106-L"));
        ...
        semesters.put("ptHybridSem8", createSemester(courseService, 8, "Summer",
                "GEOL101", "GEOL102"));

        //Semester 8 - Spring (9 units)
        semesters.put("ptHybridSem8", createSemester(courseService, 9, "Spring",
        ...
        semesters.put("ptHybridSem11", createSemester(courseService, 10, "Fall",
                "COMP310", "MATH340", "COMP380-L"));

        //Semester 10 - Winter (3 units)
        semesters.put("ptSummerSem10", createSemester(courseService, 11, "Summer",
                "POLS155"));

        //Semester 11 - Spring (9 units)
        semesters.put("ptSummerSem11", createSemester(courseService, 12, "Spring",
                "MUS107", "ANTH150", "COMP333"));

        // ─── Year 5 ───────────────────────────────────────────────────────────────

        //Semester 12 - Fall (7 units)
        semesters.put("ptSummerSem12", createSemester(courseService, 13, "Fall",
                "COMP322-L", "COMP482"));

        //Semester 13 - Spring (6 units)
        semesters.put("ptSummerSem13", createSemester(courseService, 14, "Spring",
                "GEOG321", "COMP440", "COMS356"));

        // ─── Senior Year ──────────────────────────────────────────────────────────

        //ML - Fall (9 units)
        semesters.put("ptSummerSemML14", createSemester(courseService, 15, "Fall",
                "COMP490-L", "COMP442", "COMP482"));

        //ML - Spring (9 units)
        semesters.put("ptSummerSemML15", createSemester(courseService, 16, "Spring",
                "COMP491-L", "COMP542", "COMP569"));

        //WD - Fall (9 units)
        semesters.put("ptSummerSemWD14", createSemester(courseService, 15, "Fall",
                "COMP490-L", "COMP484", "COMP484L", "COMP429"));

        //WD - Spring (9 units)
        semesters.put("ptSummerSemWD15", createSemester(courseService, 16, "Spring",
                "COMP491-L", "COMP584", "COMP585"));

        //Game Dev - Fall (9 units)
        semesters.put("ptSummerSemGD14", createSemester(courseService, 15, "Fall",
                "COMP490-L", "COMP467", "COMP485"));

        //Game Dev - Spring (9 units)
        semesters.put("ptSummerSemGD15", createSemester(courseService, 16, "Spring",
                "COMP491-L", "COMP565", "COMP585"));

        //Data Science - Fall (9 units)
        semesters.put("ptSummerSemDS14", createSemester(courseService, 15, "Fall",
                "COMP490-L", "COMP541", "COMP502"));

        //Data Science - Spring (9 units)
        semesters.put("ptSummerSemDS15", createSemester(courseService, 16, "Spring",
                "COMP491-L", "COMP542", "COMP569"));

        //Cybersecurity - Fall (9 units)
        semesters.put("ptSummerSemCS14", createSemester(courseService, 15, "Fall",
                "COMP490-L", "COMP424", "COMP429"));

        //Cybersecurity - Spring (9 units)
        semesters.put("ptSummerSemCS15", createSemester(courseService, 16, "Spring",
                "COMP491-L", "COMP522", "COMP529", "COMP529L"));

        //Software Engineering - Fall (9 units)
        semesters.put("ptSummerSemSE14", createSemester(courseService, 15, "Fall",
                "COMP490-L", "COMP440", "COMP424"));

        //Software Engineering - Spring (9 units)
        semesters.put("ptSummerSemSE15", createSemester(courseService, 16, "Spring",
