...
public class SemestersService {
    ...
    private void initializeSemesters() {
        ...
        semesters.put("ptSem1", createSemester(1, "Fall",
                "COMP110-L", "MATH150A-L"));

        semesters.put("ptSem2", createSemester(2, "Spring",
                "ENG115", "COMP182-L", "COMP122-L"));

        semesters.put("ptSem3", createSemester(3, "Fall",
                "MATH150B-L", "PHIL230"));

        semesters.put("ptSem4", createSemester(4, "Spring",
                "COMS151", "GEOL101", "GEOL102"));

        semesters.put("ptSem5", createSemester(5, "Fall",
                "COMP222", "COMP256-L"));

        semesters.put("ptSem6", createSemester(6, "Spring",
                "COMP282", "ECON101", "POLS155"));

        semesters.put("ptSem7", createSemester(7, "Fall",
                "MATH262", "BIOL106-L", "AAS100"));

        semesters.put("ptSem8", createSemester(8, "Spring",
                "GEOG321", "COMP322-L","COMS356"));

        semesters.put("ptSem9", createSemester(9, "Fall",
                "COMP310", "MATH340", "MUS107"));

        semesters.put("ptSem10", createSemester(10, "Spring",
                "HIST271", "COMP333", "COMP380-L"));

        semesters.put("ptSem11", createSemester(11, "Fall",
                "COMP324", "COMP440", "COMP490-L"));

        semesters.put("ptSem12", createSemester(12, "Spring",
                "COMP491-L", "MATH482"));
